...
export default function BirthForm() {
  ...
  return (
    <div className="space-y-12">
      ...
      {/* 2. 下部三个功能模块卡片 (严格保留性格原型、周程演化、双方共振) */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* 卡片 1: 性格原型 */}
        <div className="p-5 border border-[var(--border-line)] bg-[var(--bg-card)] backdrop-blur-md rounded-sm text-left hover:border-[var(--text-secondary)] transition-colors">
          <div className="text-[10px] tracking-widest text-[var(--cinnabar)] uppercase font-medium mb-1">
            01 / ARCHETYPE
          </div>
          <h3 className="text-xs font-bold text-[var(--text-primary)] tracking-wider mb-2">
            {dict.card1Title}
          </h3>
