...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="min-h-screen flex flex-col justify-between bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-neutral-900 via-black to-black">
        <Header />
